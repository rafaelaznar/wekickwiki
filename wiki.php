...
<body>
  ...
  <div id="wiki-screen" style="display:none">
    <header>
      ...
      <div id="header-right">
        ...
        <button class="btn" id="hub-btn" title="Back to hub" aria-label="Back to hub" style="display:none" onclick="window.location.href='index.php'"><svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  <script>
    ...
    window.WKW_AUTH_BASE = <?= json_encode($baseHref . 'index.php') ?>;
